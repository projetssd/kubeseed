...
ks_get_and_store_info  "applis.traefik.subdomain" "Sous domaine pour traefik" KS_TRAEFIK_SUBDOMAIN "traefik"
ks_get_and_store_info  "applis.traefik.auth" "Authentification pour traefik - 1 => basique (défaut) | 2 => oauth | 3 => aucune" KS_TRAEFIK_AUTH 1
